...
app.config(function($stateProvider, $urlRouterProvider, ArticlesCtrlResolve) {
  ...
  //   resolve: {
  //     todo: function($stateParams, TodosService) {
  //       console.log('$stateParams.todo ' + $stateParams.todo);
  //       return TodosService.getTodo($stateParams.todo)
  //     }
  //   }
  // })
...
app.constant('ArticlesCtrlResolve', {
  Articles: asyncServiceFuncFactory
})
.factory('TodosService',function(data){


 var todos = [
      {title: "Take out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out theTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake outTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake outTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake outTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trashTake out the trash", done: true},
...
return {
    ...
    getTodo: function(index) {
      ...
      var article = data.friends()[index];
...
app.factory('tagSortCriteria',function() {
     ...
     var jsonData = (function(){
      return {
        ...
        set: function (dataArray){
           console.log('Added num to array');
...
}).filter('urlToJS', function ($sce, $sanitize) {
    return function (article) {
      //'https?://([\S]+)'
       var newString = "<a onClick=\"window.open('" + article.url + "', '_blank', 'location=yes')\">" + article.title + "</a>";
